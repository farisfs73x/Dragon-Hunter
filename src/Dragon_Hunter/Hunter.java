...
public class Hunter {
    ...
    private Background bg1 = Begin.getBg1();
    private Background bg2 = Begin.getBg2();
    private Background bg3 = Begin.getBg3();
    private Background bg4 = Begin.getBg4();

    private ArrayList<Power> projectiles = new ArrayList<Power>();
    ...
    public void jump() {
        if (jumped == false) {
            speedY = JUMPSPEED;
            jumped = true;
            SoundEffect.makeSound("data/Sound/jump.wav");
        }
    ...
    public void shoot() {
        ...
        if (getDirection() == "right")
            p = new Power(centerX-10, centerY-5,true);
        else
            p = new Power(centerX-140, centerY-5,false);
	projectiles.add(p);
    }
